export const SUPPORT_STAFF_ROLES = ["support_agent", "support_senior", "support_manager", "employee", "admin", "viewer"] as const;
...
export function canViewAllSupport(role?: string | null) {
  return role === "support_senior" || role === "support_manager" || role === "admin" || role === "viewer";
}

export function canManageSupportAssignments(role?: string | null) {
  return role === "support_manager" || role === "admin";
}

export function canEscalateSupport(role?: string | null) {
  return role === "support_senior" || role === "support_manager" || role === "admin";
}
