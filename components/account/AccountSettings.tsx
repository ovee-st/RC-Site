...
export default function AccountSettings({ profileStorageKey, title = "Account Settings", id = "account-settings" }: AccountSettingsProps) {
  const { user } = useAuth();
  ...
  return (
    <Card id={id} className="depth-primary scroll-mt-24 p-5">
