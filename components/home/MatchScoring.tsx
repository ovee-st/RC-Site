      ...
      <Container>
        <Card className="grid gap-8 overflow-hidden rounded-[2rem] p-6 md:p-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-black tracking-tight text-slate-950 dark:text-white md:text-5xl">Transparent match scoring, not black-box magic.</h2>
            <p className="mt-4 text-base leading-7 text-slate-600 dark:text-slate-300">Recruiters can see how skills, experience, communication, availability, and salary fit drive a candidate recommendation.</p>
          </div>
