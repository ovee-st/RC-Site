    ...
    <div className="flex gap-2 overflow-x-auto pb-1">
      {CAREER_PROMPTS.map((prompt) => (
        <button
          ...
          className={cn(
            "inline-flex shrink-0 items-center gap-1.5 rounded-full border border-border bg-surface px-3 py-1.5 text-[11px] font-black text-text-muted transition hover:-translate-y-0.5 hover:border-primary/30 hover:bg-primary/5 hover:text-primary disabled:pointer-events-none disabled:opacity-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200",
          )}
        >
