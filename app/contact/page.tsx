    ...
    <main className="bg-bg py-16 dark:bg-slate-950">
      <Container>
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-4xl font-black tracking-tight text-text-main dark:text-white md:text-5xl">Contact MX Venture Lab</h1>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <Card className="rounded-md p-6">
            ...
            <form className="mt-5 grid gap-4">
              ...
              <textarea name="message" placeholder="Message" rows={6} className="rounded-md border border-border bg-white px-4 py-3 text-sm font-semibold outline-none transition placeholder:text-text-muted focus:border-primary focus:ring-4 focus:ring-primary/10 dark:border-white/10 dark:bg-white/5 dark:text-white" />
              <Button type="button" className="justify-center">Submit Message</Button>
            </form>
          </Card>
        </div>
      </Container>
